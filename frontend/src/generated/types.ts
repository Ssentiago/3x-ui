...
export interface Client {
  ...
  enable: boolean;
  expiryTime: number;
  expiryTimeMode: FieldMode;
  flow?: string;
  group?: string;
  id?: string;
  keepAlive?: number;
  limitIp: number;
  limitIpMode: FieldMode;
  password?: string;
  preSharedKey?: string;
  privateKey?: string;
  publicKey?: string;
...
export interface TariffProfileItem {
  id: number;
  name: string;
  position: number;
}
...
export interface TariffSummary {
  ...
  inboundStrategy: string;
  name: string;
  profiles?: TariffProfileItem[];
  resolved?: ResolvedFields | null;
  trafficStrategy: string;
  updatedAt: number;
}
