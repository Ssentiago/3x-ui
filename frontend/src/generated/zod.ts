...
import { z } from 'zod';
export const FieldModeSchema = z.string();
...
export const ClientSchema = z.object({
  ...
  expiryTimeMode: z.lazy(() => FieldModeSchema),
  flow: z.string().optional(),
  group: z.string().optional(),
  id: z.string().optional(),
  keepAlive: z.number().int().optional(),
  limitIp: z.number().int(),
  limitIpMode: z.lazy(() => FieldModeSchema),
  ...
  totalGBMode: z.lazy(() => FieldModeSchema),
...
export const ProfileSchema = z.object({
  createdAt: z.number().int(),
  expiryDays: z.number().int().nullable().optional(),
  id: z.number().int(),
  inboundIds: z.string(),
...
export const TariffProfileSchema = z.object({
  ...
  tariffId: z.number().int(),
});
export type TariffProfile = z.infer<typeof TariffProfileSchema>;

export const TariffProfileItemSchema = z.object({
  id: z.number().int(),
  name: z.string(),
  position: z.number().int(),
});
export type TariffProfileItem = z.infer<typeof TariffProfileItemSchema>;
...
export const TariffSummarySchema = z.object({
  ...
  inboundStrategy: z.string(),
  name: z.string(),
  profiles: z.array(z.lazy(() => TariffProfileItemSchema)).optional(),
  resolved: z.lazy(() => ResolvedFieldsSchema).nullable().optional(),
  trafficStrategy: z.string(),
  updatedAt: z.number().int(),
});
